...
public class GeoJSONReader {
    ...
    private static com.vividsolutions.jts.geom.Geometry convert(GeometryCollection geoJSON) {
        ...
        com.vividsolutions.jts.geom.Geometry[] collection =
    ...
    private static com.vividsolutions.jts.geom.Geometry convert(MultiLineString multiLineString) {
        ...
        com.vividsolutions.jts.geom.LineString[] lineStrings =
            new com.vividsolutions.jts.geom.LineString[size];
        for (int i = 0; i < size; i++) {
            Coordinate[] coordinates = convert(multiLineString.getCoordinates()[i]);
    ...
    private static com.vividsolutions.jts.geom.Geometry convert(MultiPolygon multiPolygon) {
        ...
        com.vividsolutions.jts.geom.Polygon[] polygons =
            new com.vividsolutions.jts.geom.Polygon[size];
        for (int i = 0; i < size; i++) {
